...
async def run_pipeline(session: AsyncSession) -> PipelineRun:
    ...
    try:
        ...
        all_articles = []
        source_names = ["google_news", "gnews", "yc_directory", "rss_feeds"]
        ...
        for article in all_articles:
            try:
                ...
                # Draft email — failure does not prevent lead storage
                if profile:
                    lead_data = {
                ...
                errors.append({"article": article.headline[:80], "error": str(e)})
