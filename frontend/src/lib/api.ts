...
import type { Lead, LeadsResponse, StatsResponse, PipelineStatus, RegenerateEmailResponse, LeadFilters, LeadUpdate } from './types';
...
export async function regenerateEmail(id: string): Promise<RegenerateEmailResponse> {
  return apiFetch<RegenerateEmailResponse>(`/api/leads/${id}/regenerate`, { method: 'POST' });
}
